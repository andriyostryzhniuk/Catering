package ostryzhniuk.andriy.catering.overridden.elements.number.spinner;
...
public class NumberSpinner extends TextField {
    ...
    public NumberSpinner() {
        ...
        sceneProperty().addListener(new ChangeListener<Scene>() {
            ...
            public void changed(ObservableValue<? extends Scene> observableValue, Scene scene, Scene scene1) {
                if (scene1 != null) {
                    scene1.getStylesheets().add(getClass().getResource("/styles/NumberSpinnerStyle.css").toExternalForm());
                }
            }
        });
    }
    ...
    public String getUserAgentStylesheet() {
        return getClass().getResource("/styles/NumberSpinnerStyle.css").toExternalForm();
    }
}